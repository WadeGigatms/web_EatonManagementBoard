...
const PopUpTimeline = ({ epc }) => {
    ...
    function render(epc) {
        ...
        const modalFooter = () => {
            if (epc.epcContext.readerId !== "Terminal" && epc.epcContext.readerId !== "ManualTerminal") {
            ...
            else if (epc.epcContext.readerId === "ManualTerminal") {
                return <div className="modal-footer justify-content-between">
                ...
                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="ModalCenterTitle">{TH_PALLET_TRACE}: {epc.epcDataDto.palletId}</h5>
